...
## Junos OS 23.2R2.21 | VM ID 153 (rebuild on 23.2R2.21) | Role: AutoVPN Spoke
...
> (`04-srx04-spoke-config.md`) with a full-tunnel traffic selector and a default route into
...
- The host route to the hub WAN IP (`10.0.0.2/32 → 10.0.3.1`) is **retained and is now
